...
"[project]/stock-dashboard/src/app/api/search/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    if (!apiKey) {
        ...
        const results = DUMMY_STOCKS.filter((s)=>s.symbol.toLowerCase().includes(lower) || s.name.toLowerCase().includes(lower)).slice(0, 8);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__021-xwm._.js.map